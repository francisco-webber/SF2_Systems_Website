...
Enthalten:
- demo-sensor-log.csv: Beispiel-Zeitreihe fuer den ersten Workflow
- install-linux-x86.txt: Installationsleitfaden Linux x86
- install-linux-arm.txt: Installationsleitfaden Linux ARM
- install-windows-x86.txt: Installationsleitfaden Windows x86
